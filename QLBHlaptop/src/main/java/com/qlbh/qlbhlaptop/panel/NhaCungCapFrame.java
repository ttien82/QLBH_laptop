...
public class NhaCungCapFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(NhaCungCapFrame.class.getName());
    ...
    private void initComponents() {
        ...
        tblNhaCungCap.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        NhaCungCap_Dialog_Them dialog = new NhaCungCap_Dialog_Them(this); // this = SanPhamFrame
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        int selectedRow = tblNhaCungCap.getSelectedRow(); 
        NhaCungCap_Dialog_Sua dialog = new NhaCungCap_Dialog_Sua(this, tblNhaCungCap.getValueAt(selectedRow, 0).toString()); // this = SanPhamFrame
        dialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {
                fillTableData();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int result = JOptionPane.showConfirmDialog(
            ...
            "Bạn có chắc chắn muốn xóa NCC này?",  // Nội dung
            "Xác nhận",                     // Tiêu đề
        ...
        if (result == JOptionPane.YES_OPTION) {
            dao.delete(tblNhaCungCap.getValueAt(selectedRow, 0).toString());
            fillTableData();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NhaCungCapFrame().setVisible(true));
