...
public class NhanVienFrame extends javax.swing.JFrame {
    ...
    private void InitTblNhanVien()
    {
        ...
        String[] columns = {"Mã NV", "Tên NV", "Địa chỉ", "Điện thoại"};
    ...
    private void initComponents() {
        ...
        tblNhanVien.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        NhanVien_Dialog_Them dialog = new NhanVien_Dialog_Them(this); // this = NVFrame
        
        // Gọi hàm fill lại dữ liệu khi ThemNVFrame đóng
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        NhanVien_Dialog_Sua dialog = new NhanVien_Dialog_Sua(this, tblNhanVien.getValueAt(selectedRow, 0).toString()); // this = NVFrame
        dialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int result = JOptionPane.showConfirmDialog(
            ...
            "Bạn có chắc chắn muốn xóa NhanVien này?",  // Nội dung
            "Xác nhận",                     // Tiêu đề
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NhanVienFrame().setVisible(true));
