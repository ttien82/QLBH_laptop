...
public class KhachHangFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(KhachHangFrame.class.getName());
    ...
    private void InitTblKhachHang()
    {
        //1.Arr[string] chứa tiêu đề các cột
        String[] columns = {"Mã KH", "Tên KH", "Địa chỉ", "Email", "Điện thoại"};
        model = new DefaultTableModel(columns, 0);
        tblKhachHang.getSelectionModel().addListSelectionListener(e -> {
        //disable btnEdit, btnDelete
    ...
    //Fill data vao tblNV && Reload Data
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        KhachHang_Dialog_Them dialog = new KhachHang_Dialog_Them(this); // this = NVFrame
        
        // Gọi hàm fill lại dữ liệu khi ThemKHFrame đóng
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        int selectedRow = tblKhachHang.getSelectedRow(); 
        KhachHang_Dialog_Sua dialog = new KhachHang_Dialog_Sua(this, tblKhachHang.getValueAt(selectedRow, 0).toString());
        dialog.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {
                fillTableData();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int result = JOptionPane.showConfirmDialog(
            ...
            "Bạn có chắc chắn muốn xóa KhachHang này?",  // Nội dung
            "Xác nhận",                     // Tiêu đề
        ...
        if (result == JOptionPane.YES_OPTION) {
            dao.delete(tblKhachHang.getValueAt(selectedRow, 0).toString());
            fillTableData();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new KhachHangFrame().setVisible(true));
